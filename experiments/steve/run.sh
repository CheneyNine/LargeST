...
# python experiments/steve/main.py --device cuda:0 --dataset GLA --years 2019 --model_name steve --seed 2023 --bs 8 --input_dim 3 --traffic_dim 3 --embed_dim 64 --spatial_sample_size 256 --mi_sample_size 2048
