...
# python experiments/timellm/main.py --device cuda:0 --dataset SD --years 2019 --model_name timellm --seed 2023 --bs 16 --seq_len 12 --horizon 12 --input_dim 3 --traffic_dim 3 --llm_model GPT2 --llm_local_files_only 1 --llm_allow_download 1 --prompt_mode stats --prompt_granularity batch --run_tag sd_stats
...
# python experiments/timellm/main.py --device cuda:0 --dataset SD --years 2019 --model_name timellm --seed 2023 --bs 4 --seq_len 12 --horizon 12 --input_dim 3 --traffic_dim 3 --llm_model GPT2 --prompt_mode text --prompt_granularity batch --prompt_max_tokens 64 --run_tag sd_text
