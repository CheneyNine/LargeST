...
# python experiments/e2cstp/main.py --device cuda:0 --dataset GLA --years 2019 --model_name e2cstp --seed 2023 --bs 8 --input_dim 3 --st_dim 3 --text_dim 0 --image_dim 0
# python experiments/e2cstp/main.py --device cuda:0 --dataset GBA --years 2019 --model_name e2cstp --seed 2023 --bs 16 --input_dim 3 --st_dim 3 --text_dim 0 --image_dim 0
